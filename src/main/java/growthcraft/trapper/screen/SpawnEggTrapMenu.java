...
public class SpawnEggTrapMenu extends AbstractContainerMenu {
    ...
    private final SpawnEggTrapBlockEntity blockEntity;
    private final SpawnEggTrapBlock block;
    ...
    public SpawnEggTrapMenu(int containerId, Inventory inventory, BlockEntity blockEntity) {
        ...
        this.blockEntity = (SpawnEggTrapBlockEntity) blockEntity;
        this.block = (SpawnEggTrapBlock) inventory.player.level.getBlockEntity(this.blockEntity.getBlockPos()).getBlockState().getBlock();
